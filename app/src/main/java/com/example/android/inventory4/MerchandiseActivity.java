    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            private void insertStock() {
                ...
                values.put(StockEntry.COLUMN_STOCK_NAME, "How to Draw & Paint Cars");
                values.put(StockEntry.COLUMN_STOCK_PRICE, "13.79");
                values.put(StockEntry.COLUMN_STOCK_QUANTITY, "20");
                values.put(StockEntry.COLUMN_STOCK_SUPPLIER, "Tony Gardiner");
